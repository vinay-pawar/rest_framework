...
@JsonInclude(JsonInclude.Include.NON_NULL) @JsonPropertyOrder({ "id", "category", "name", "photoUrls", "tags",
  "status" }) public class PetResponse {
   ...
   * @param status
   */
  public PetResponse(Integer id, Category category, String name, List<String> photoUrls, List<Tag> tags,
    String status) {
    super();
    this.id = id;
  ...
  public String toString() {
    ...
    sb.append(PetResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
      .append('[');
    sb.append("id");
    sb.append('=');
  ...
  public boolean equals(Object other) {
    ...
    PetResponse rhs = ((PetResponse) other);
